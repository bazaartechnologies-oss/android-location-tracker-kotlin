...
public class SamplePresenter {
    ...
    public void onLocationFailed(@FailType int failType) {
        ...
        switch (failType) {
            ...
            case FailType.DEFAULT_CONFIGURATION_NOT_FOUND: {
                sampleView.setText("Couldn't get location, because user default default configuration not found");
                break;
            }

            case FailType.GOOGLE_PLAY_CONFIGURATION_NOT_FOUND: {
                sampleView.setText("Couldn't get location, because user default google configuration not found");
                break;
            }
