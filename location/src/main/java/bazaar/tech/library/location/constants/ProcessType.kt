...
@IntDef(ProcessType.ASKING_PERMISSIONS, ProcessType.GETTING_LOCATION_FROM_GOOGLE_PLAY_SERVICES, ProcessType.GETTING_LOCATION_FROM_GPS_PROVIDER, ProcessType.GETTING_LOCATION_FROM_NETWORK_PROVIDER, ProcessType.GETTING_LOCATION_FROM_CUSTOM_PROVIDER)
...
annotation class ProcessType {
    companion object {
         ...
         */
        const val ASKING_PERMISSIONS = 1
